  ...
  try {
    ...
    return NextResponse.json({
      ...
      quote: {
        ...
        externalOlistInvoiceNumber: loaded.detail.quote.external_olist_invoice_number,
        externalOlistInvoiceSeries: loaded.detail.quote.external_olist_invoice_series,
        externalOlistInvoiceModel: loaded.detail.quote.external_olist_invoice_model,
