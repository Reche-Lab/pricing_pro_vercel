    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 grid place-items-center overflow-hidden bg-black/70 p-0 backdrop-blur-sm sm:px-4 sm:py-6">
          <div role="dialog" aria-modal="true" aria-labelledby="quote-items-edit-title" className="flex h-dvh w-full max-w-3xl min-w-0 flex-col overflow-hidden border border-zinc-800 bg-zinc-950 shadow-2xl shadow-black/50 sm:max-h-[90dvh] sm:rounded-lg">
            <div className="flex shrink-0 items-start justify-between gap-3 border-b border-zinc-800 p-4 sm:gap-4 sm:p-5">
              <div className="min-w-0">
                <h3 id="quote-items-edit-title" className="text-base font-semibold text-white">Editar orçamento</h3>
                <p className="mt-1 text-sm leading-5 text-zinc-500">
                  Produtos e condições do orçamento.
                </p>
              </div>
              <button
                aria-label="Fechar edição do orçamento"
