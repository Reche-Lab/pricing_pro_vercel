...
export function PrintGeometryFields({ defaults }: { defaults?: Partial<PrintGeometryFormValues> }) {
  ...
  return (
    <div className="mt-4 rounded-lg border border-cyan-900/60 bg-cyan-950/20 p-4">
      ...
      <p className="mt-1 text-xs leading-5 text-zinc-500">As dimensões são finais, sem sangria. A mesma geometria será usada no enquadramento, na linha de corte e na montagem A4.</p>
