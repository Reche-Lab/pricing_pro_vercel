...
export function classifyTransaction(
  ...
  return {
    ...
    includeExternalCashFlow: transaction.entryKind?.startsWith("card_") ? false : matched.actions.includeExternalCashFlow ?? transaction.includeExternalCashFlow,
    includeOperatingResult: transaction.entryKind === "bill_payment" ? false : matched.actions.includeOperatingResult ?? transaction.includeOperatingResult,
